...
def prepare():
    ...
    # create an explain object of command line
    parser = argparse.ArgumentParser()
    # add the markrameter for this object
    parser.add_argument('configs', nargs='+')
    # default value for parameter '--devices'
    parser.add_argument('--devices', default=None)
    # action='store_true'，defualt value for parameter '--evaluate'
    parser.add_argument('--evaluate', default=False, action='store_true')
    # set visualization for s3dis
    parser.add_argument('--visual', default= False, action='store_true')
    # args namespace
    args, opts = parser.parse_known_args()
    if args.devices is not None and args.devices != 'cpu':
        # return the selected GPU id
    ...
    # set visualization
    if args.visual is not None and args.visual != False:
        configs.visual = True
    else:
        configs.visual = False
