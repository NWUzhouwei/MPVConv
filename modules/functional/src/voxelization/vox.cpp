...
/*
  ...
  Args:
    ...
    coords  : voxel coords of each point, IntTensor[b, 3, n]
    resolution : voxel resolution
  Return:
    out : outputs for voxelized Features, FloatTensor[b, c, s], s = r ** 3
...
std::vector<at::Tensor> avg_voxelize_forward(const at::Tensor features,
  ...
  int r2 = r * r;
  int r3 = r2 * r;
  // Open the space of the variable to be output in the memory
  ...
  // Call the function written by CUDA
